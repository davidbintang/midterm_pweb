  ...
  <div class="card">
   <div class="card-body">
    ...
    <table class="table table-bordered">
		...
		<?php $__currentLoopData = $daftar_game; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<tr>
			<td><?php echo e($p->id_game); ?></td>
			<td><?php echo e($p->id_developer); ?></td>
			<td><?php echo e($p->Nama_Game); ?></td>
			<td><?php echo e($p->Genre); ?></td>
            <td><?php echo e($p->Rating); ?></td>
            <td><?php echo e($p->Harga); ?></td>
            <td><?php echo e($p->Tanggal_Rilis); ?></td>
...
</html><?php /**PATH C:\xampp\htdocs\FP_MBD\resources\views/index.blade.php ENDPATH**/ ?>